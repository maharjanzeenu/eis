        ...
        (function () {
            ...
            tracker.track = {
                outerOpen: function (parameters) {
                    ...
                    return track("i18n.loc.partiallyReplacedTemplate", {template_key: key, template_value: value})
            ...
            tracker.trace = {
                trigger: function (eventName, args) {
                    ...
                    return trace("rpc.postMessage." + method, {id: id, args: traceSerialize(args)})
                }
            };
            tracker.state = {
        ...
        (function () {
            ...
            App = function () {
                function App(options) {
                    ...
                    this.configurations = {};
                    this.checkouts = {};
                    this.constructorOptions = {host: "https://checkout.stripe.com", forceManhattan: false};
            ...
            Checkout = function () {
                ...
                Checkout.prototype.createView = function (useManhattan) {
                    ...
                    if (helpers.isFallback()) {
                        ...
                        path = "/v3/fallback/bfjk8hhcyIkncy2WkK6jg.html"
                    } else {
                        if (this.shouldPopup) {
                            viewClass = TabView
                        } else {
                        ...
                        if (useManhattan) {
                            path = "/m/v3/index-f8d829462edda49dc365.html"
                        } else {
                            path = "/v3/yiWszEIcz0H0K2eT1bmgQ.html"
                        }
                    }
                    ...
                    cb = function (_this) {
                        return function () {
                            ...
                            iframeFallback = function () {
                                ...
                                this.view = new IframeView(this.onToken, this.host, "/v3/yiWszEIcz0H0K2eT1bmgQ.html");
                    ...
                    return ready(function (_this) {
                        return function () {
                            ...
                            return _this.rpc.ready(function () {
                                ...
                                return _this.rpc.invoke("open", {timeLoaded: _this.options.timeLoaded})
                            })
                        }
                    }(this))
                };
